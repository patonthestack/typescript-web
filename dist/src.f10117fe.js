...
function () {
  function Attributes(data) {
    ...
    this.data = data; // letter 'K' represents a type, just like 'T'
...
exports.Attributes = Attributes; // example of the get with returning T[K]:
...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id; //same as data.id
...
user.fetch(); // Reminder on how 'this' works in javascript
// const colors = {
// 	color: 'red',
// 	printColor() {
